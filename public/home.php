    ...
    <main class="main">
        <section class="info" id="servicios">
            ...
            <div class="info__text">
                ...
                Perferendis dolores doloremque animi magnam earum? Tempora repellat adipisci et magnam minus excepturi dolorem nihil possimus amet suscipit. Tempore, accusamus officia!</p>
            </div>
        </section>
            ...
            <div class="content-contacto">
                <div class="redes">
                    <div class="redes__iten">
                        <a href="#"><i class="fab fa-whatsapp fa-3x fa-fw icon-redes"></i></a>
                        <a href=""><i class="fas fa-phone fa-3x fa-fw icon-redes"></i></a>
                        <a href=""><i class="fab fa-facebook fa-3x fa-fw icon-redes"></i></a>
                        <a href=""><i class="fab fa-instagram fa-3x fa-fw icon-redes"></i></a>
